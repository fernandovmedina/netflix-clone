  ...
  return (
    <nav className="text-white flex flex-row items-center px-14 py-4 w-full">
      ...
      <div className="flex flex-row items-center w-9/12 justify-start px-7 gap-5 text-sm">
        <Link href={`/home?uuid=${uuid}`} className="hover:text-gray-400/90">
          Home
        </Link>
        <Link
        ...
        <Link href={`/home/movies?uuid=${uuid}`} className="hover:text-gray-400/90">
          Movies
        </Link>
        <Link href={`/home/new_arrivals?uuid=${uuid}`} className="hover:text-gray-400/90">
          Popular new arrivals
        </Link>
        <Link href={`/home/my_list?uuid=${uuid}`} className="hover:text-gray-400/90">
          My List
        </Link>
      </div>
