const ProfileCardsManage = () => {
    ...
    return (
        <div className="my-5 flex">
            ...
            <a href="/addProfile" className="my-auto text-gray-400 hover:text-white" id="addDIV">
...
const Card = ({name, url}) => {
    return (
        <div className="relative mx-3 text-gray-400 hover:text-white">
            <div className="relative inline-block">
                <img className="w-36 rounded hover:border-2 hover:border-white" src={url} alt="image_url" />
                <img className="absolute top-0 left-1/2 transform -translate-x-1/2 w-10" src="/edit_pencil_white.png" alt="edit_pencil_white_image" />
            </div>
...
export default ProfileCardsManage;
